...
class DefaultSignUpHandler implements SignUpHandler
{
    ...
    public static function rules($forSignup = true): array
    {
        ...
        $rules = [
            ...
            'shipping_phone'      => 'required_if:use_different_shipping,1',
    ...
    public static function messages(): array
    {
        $messages = [
            ...
            'billing_phone.required'       => trans('webbook.mall::lang.components.signup.errors.phone.required'),
            ...
            'shipping_phone.required_if'   => trans('webbook.mall::lang.components.signup.errors.phone.required'),
