...
return [
    ...
    'vat.valid' => 'The VAT number was successfully verified in VIES.',
    'vat.invalid' => 'The VAT number is not valid in VIES. Standard VAT will be applied to the order.',
    'vat.unavailable' => 'VIES is currently unavailable. Standard VAT will be applied to the order.',
    'vat.exempt' => 'The VAT number was verified. The order qualifies for purchase without VAT.',
    'vat.valid_not_exempt' => 'The VAT number is valid, but the current billing and shipping details do not qualify for purchase without VAT.',
    'labels' => 'Labels',
