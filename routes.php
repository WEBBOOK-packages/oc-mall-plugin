...
use WebBook\Mall\Classes\Feeds\GoogleMerchantFeed;
use WebBook\Mall\Models\FeedSettings;

// Send virtual product files to the user's browser.
Route::get('/mall/download/{key}/{idx?}', '\WebBook\Mall\Classes\Downloads\VirtualProductFileDownload@handle')
    ->middleware('web');
...
//
// @see \WebBook\Mall\Classes\Payments\PaymentRedirector::handlePaymentResult
