...
class CreateWebBookMallOrderProducts extends Migration
{
    public function up()
    {
        Schema::create('webbook_mall_order_products', function ($table) {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('webbook_mall_order_products');
    }
}
