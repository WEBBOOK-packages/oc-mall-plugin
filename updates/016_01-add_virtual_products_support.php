...
class AddVirtualProductsSupport extends Migration
{
    public function up()
    {
        Schema::table('webbook_mall_products', function (Blueprint $table) {
        ...
        Schema::create('webbook_mall_product_files', function (Blueprint $table) {
            $table->engine = 'InnoDB';
        ...
        Schema::create('webbook_mall_product_file_grants', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->increments('id')->unsigned();
        ...
        Schema::table('webbook_mall_orders', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('webbook_mall_product_files');
        Schema::dropIfExists('webbook_mall_product_file_grants');
    }
}
