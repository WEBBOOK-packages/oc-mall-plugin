...
class Cruiser3000 extends DemoProduct
{
    protected function attributes(): array
    {
        return [
            ...
            'slug'                         => 'cruiser-3000',
            'name'                         => 'Cruiser 3000',
            'description'                  => trans('webbook.mall::demo.products.cruiser_3000.description'),
            'description_short'            => trans('webbook.mall::demo.products.cruiser_3000.description_short'),
            'meta_title'                   => trans('webbook.mall::demo.products.cruiser_3000.meta_title'),
            'meta_description'             => trans('webbook.mall::demo.products.cruiser_3000.meta_description'),
    ...
    protected function properties(): array
    {
        return [
            'color'       => [
                'name'  => trans('webbook.mall::demo.products.properties.heavens_blue'),
                'hex'   => '#02bbe6',
            ],
            'rear-travel' => '0',
            'fork-travel' => '130',
